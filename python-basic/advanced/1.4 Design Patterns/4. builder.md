...
- [__init__()](file:///Users/luke-surface-mac/code/PythonPursuit/python-basic/advanced/1.4%20Design%20Patterns/Creational-Patterns/builder/builder_demo.py#L2-L6): 初始化方法
- [__repr__()](file:///Users/luke-surface-mac/code/PythonPursuit/python-basic/advanced/1.3%20Metaprogramming%20and%20Reflection/metaclass/orm_demo.py#L93-L95): 字符串表示方法
- `__eq__()`: 相等比较方法
...
3. **可选参数**：
   - `@dataclass(init=False)`：不生成 [__init__](file:///Users/luke-surface-mac/code/PythonPursuit/python-basic/advanced/1.4%20Design%20Patterns/Creational-Patterns/builder/builder_demo.py#L2-L6)
   - `@dataclass(repr=False)`：不生成 [__repr__](file:///Users/luke-surface-mac/code/PythonPursuit/python-basic/advanced/1.3%20Metaprogramming%20and%20Reflection/metaclass/orm_demo.py#L93-L95)
